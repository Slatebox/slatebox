...
import { Messages, Slates, Collaboration, Organizations, Claims, Permissions, PricingTiers, SlateAccess, Collaborators, Comments } from '/imports/api/common/models.js';
...
Meteor.publish(CONSTANTS.publications.users.me, function publishMe() {
  console.log("publishing me ", this.userId);
