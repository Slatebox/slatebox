...
import createEdgeNGrams from '../../imports/api/common/createEdgeNGrams.js';
import { Claims, PricingTiers, CachedImages, CachedImageTiming, SlateSnapshots, Collaboration, Slates } from '../../imports/api/common/models.js';
...
const saasTiers = [
  {
    ...
    description: [`${CONSTANTS.privateSlateLimit} Private Slates`, 'Unlimited PUBLIC slates', 'Unlimited shapes', 'Unlimited PUBLIC Collaboration', '5 Guest Day Passes/Month'],
  ...
  },
  {
    ...
    description: ['Unlimited PRIVATE slates', 'Integrated image search', 'Unlimited shapes', 'Unlimited Collaboration:', '(public for non solo users, private for other solo users)', '25 Guest Day Passes/Month'],
    buttonText: 'Go Solo',
  ...
  },
  {
    ...
    description: ['Unlimited PRIVATE slates', 'Integrated image search', 'Unlimited shapes', 'Unlimited PRIVATE team collaboration', 'Unlimited PUBLIC collaboration', '25 Guest Day Passes/Month'],
...
const selfHostedTiers = [
  {
    ...
    description: ['Host On Your Servers', 'Unlimited PRIVATE slates', 'Integrated image search', 'Unlimited shapes', 'Unlimited PRIVATE Collaborators'],
    buttonText: 'Contact Us',
    action: "github",
    buttonVariant: 'outlined',
  },
  {
    ...
    description: ['All of Community Edition, PLUS:', 'Installation & ongoing support', 'Monthly Software Updates', 'Priority Email Support'],
    buttonText: 'Contact Us',
    action: "contact",
    buttonVariant: 'outlined'
  },
  {
    ...
    description: ['All of Community Edition, PLUS:', 'Installation & ongoing support', 'Real-Time Software Updates', 'Priority Email Support', 'Screen Sharing Support'],
    buttonText: 'Contact Us',
    action: "contact",
    buttonVariant: 'contained'
  },
  {
    ...
    description: ['All of Community Edition, PLUS:', 'Installation & ongoing support', 'Real-Time Software Updates', 'Priority Email Support', 'Screen Sharing Support', 'Slatebox Cloud'],
    buttonText: 'Contact Us',
    action: "contact",
    buttonVariant: 'outlined'
  }
