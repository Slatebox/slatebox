...
# for some reason npm install sharp causes the meteor dir to be wiped!
echo 'saving meteor dir'
mv meteor .savemeteor
echo 'saved meteor dir'
rm -fr sharp
npm install -D sharp
mv .savemeteor meteor
# npm install @babel/runtime
