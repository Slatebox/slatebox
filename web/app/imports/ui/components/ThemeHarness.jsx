...
export const ThemeHarness = (props) => {
  ...
  useEffect(() => {
    snap.current = new Slatebox.Slate({
      ...
      containerStyle: {
        ...
        backgroundColorAsGradient:
          props.theme.containerStyle.backgroundColorAsGradient,
        backgroundGradientType:
          props.theme.containerStyle.backgroundGradientType,
        backgroundGradientColors:
          props.theme.containerStyle.backgroundGradientColors,
        backgroundGradientStrategy:
          props.theme.containerStyle.backgroundGradientStrategy,
      },
      viewPort: {
    ...
    Array.from({ length: 15 }).forEach((a, i) => {
      ...
      nodeOptions.vectorPath = Slatebox.Utils.lowLevelTransformPath(
