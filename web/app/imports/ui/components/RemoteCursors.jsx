...
export const RemoteCursors = (props) => {
  ...
  useEffect(() => {
    let hexColors = Slatebox.utils.availColors.map((a) => { return a.hex; });
    let foreColors = Slatebox.utils.availColors.map((a) => { return a.fore; });
  ...
  return (
    <Grid ref={cursorParent} container style={{ height: "calc(100% - 64px)", backgroundColor: props.backgroundColor }}> 
