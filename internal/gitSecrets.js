...
for (let env of ["PROD_ROOT_URL", "PROD_MONGO_URL", "PROD_MONGO_OPLOG_URL", "PROD_PORT", "PROD_METEOR_SETTINGS", "TEST_ROOT_URL", "TEST_MONGO_URL", "TEST_MONGO_OPLOG_URL", "TEST_PORT", "TEST_METEOR_SETTINGS"]) {
