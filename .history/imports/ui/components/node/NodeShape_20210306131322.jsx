...
export const NodeShape = (props) => {
  ...
  const updateOptions = (opts) => {
    ...
    console.log("width height", props.node.options.width, props.node.options.height, props.node.vect.getBBox(), opts.max);
    let path = Slatebox.utils._transformPath(opts.vectorPath, `s${s},${s}`);
